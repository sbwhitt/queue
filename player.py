...
class player(Thread):
    def __init__(self):
        ...
        self.laptop_id = DEVICES['laptop']
        self.phone_id = DEVICES['phone']
        ...
        self.master_tracks = self.spot.user_playlist_tracks(username, playlist_id=self.master['uri'])
        self.position = 0
    ...
    def start_track(self):
        self.spot.start_playback(context_uri=self.master['uri'], offset={'position' : self.position}, device_id=self.phone_id)
